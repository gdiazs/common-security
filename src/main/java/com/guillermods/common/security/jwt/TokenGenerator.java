package com.guillermods.common.security.jwt;
...
public class TokenGenerator {
	...
	public TokenGenerator(String secret, Long expiration) {
		super();
		this.secret = secret;
    ...
    public Boolean validateToken(String token, UserDetails userDetails) {
        ...
        final Date created = this.getCreatedDateFromToken(token);
        //final Date expiration = this.getExpirationDateFromToken(token);
        boolean createdBeforeLastPasswordRest = this.isCreatedBeforeLastPasswordReset(created, user.getLastPasswordResetDate()); 
        boolean expired = this.isTokenExpired(token);
        return (username.equals(user.getUsername())
                && !(expired)
                && !(createdBeforeLastPasswordRest));
    }
